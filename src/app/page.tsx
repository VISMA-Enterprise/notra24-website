...
export default function HomePage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <section style={{ display: "flex", alignItems: "center", justifyContent: "flex-start", width: "100%", minHeight: 620, position: "relative", paddingInline: 80, overflow: "hidden", background: "linear-gradient(135deg, #FCF5EE 0%, #E8C9A8 40%, #C4956C 100%)" }}>
